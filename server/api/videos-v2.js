   ...
   listAll(videosRef)
    .then((r) => {
     ...
     r.items.forEach((itemRef) => {
      videoArr.push(
       "https://firebasestorage.googleapis.com/v0/b/wetube-dev.appspot.com/o/" +
        itemRef._location.path_.replace("videos/", "videos%2F") +
        "&token=a6b12951-62af-48ef-a32f-f8f54c254c3d"
      );
