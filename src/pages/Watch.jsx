...
function Watch() {
 ...
 React.useEffect(() => {
  getVideo(["by_id", new URLSearchParams(search).get("i")], (data) => {
   setVideo(data);
  });
  window.scrollTo({
   top: 0,
        ...
        <div className="videobox">
         <div
          ...
          style={{
           ...
           backgroundImage: `url(https://firebasestorage.googleapis.com/v0/b/wetube-dev.appspot.com/o/photos%2Fvideo%2F${video.thumbnail}?alt=media)`,
